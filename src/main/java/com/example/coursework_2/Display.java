...
//            System.out.println("Animation completed for the entire path.");
    ...
    /**
     * Initializes the reading of all data files
     */
    ...
    private void addButtonStageSeven(VBox vBox){
        ...
        receiptButton.textProperty().bind(new SimpleStringProperty("Print Receipts"));
    ...
    /**
     * Print the receipts of processed parcels to receipts.txt
     * @throws FileNotFoundException
     * thrown if you can't make/find receipts.txt
     */
    private void printReceipts() throws FileNotFoundException{
        PrintWriter outputFile = new PrintWriter("receipts.txt");
        for (Parcel parcel: Data.getProcessedParcels()){
            outputFile.println(parcel.toString());
        }
        outputFile.close();
    }
